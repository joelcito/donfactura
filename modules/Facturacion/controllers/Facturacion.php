...
class Facturacion extends AdminController
{
    ...
    public function factura($id = '')
    {
        ...
        if ($id == '') {
            // $title = _l('add_new', _l('titulo_agregar_nueva_factura'));
            $title = _l('titulo_agregar_nueva_factura');
        } else {
            $data['factura'] = $this->facturacion_model->get($id);
            // $title = _l('edit', _l('titulo_agregar_nueva_factura'));
            $title = _l('titulo_agregar_nueva_factura');
        }
        ...
        $data['clientes'] = $this->Invoices_model->get_paid_invoices();

        // var_dump($data['clientes'][0]);
        // exit;
