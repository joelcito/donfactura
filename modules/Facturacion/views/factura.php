            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group select-placeholder">
                                    ...
                                    ?>
                                    <select name="cliente_id" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" onchange="generar(this)" >
                                        <option value=""></option>
                                        <?php 
                                            foreach ($clientes as $cliente) { 
                                            $cliente_json = json_encode($cliente);
                                        ?>
                                            <option value='<?php echo $cliente_json; ?>'>
                                                <?php 
                                                // echo e($cliente['company']); 
                                                echo $cliente->formatted_number;
                                                ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <b><?php echo _l('datos_cliente')?></b><br>
                                        <?php echo _l('nombre_cliente')?><span id="nombre_cliente"></span>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <!-- DE AQUI APRA ABAJO ES OTRAS COPSA DE OTRO FORMULARIO PERO SIRVE DE REFERENCIA -->
...
function generar(valor) {
    let datos_cliente = JSON.parse(valor.value);
    $('#nombre_cliente').text(datos_cliente.company)
}
</script>
</body>
</html>
